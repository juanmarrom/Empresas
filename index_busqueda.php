	...
	<div id="wrap">
		<header>
			...
			?>
				...
				<span>
					<button id="id_salir" class="btn btn-outline-secondary btn-header" onclick="if(confirm('¿Desea realmente salir de aplicación?'))location.href ='salir.php';">Salir</button>
				</span>						
			</div>
		</header>
